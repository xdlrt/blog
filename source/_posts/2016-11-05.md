...
[DynaTrace Ajax](https://ajax.dynatrace.com/pages/download/download.aspx)和最近Google发布的[SpeedTracer](https://code.google.com/webtoolkit/speedtracer/)是两个非常棒的深入了解重绘和重排的工具-前者是IE使用，后者是WebKit。
